...
- **Windows**: скачай и запусти **[clop Setup 2.5.1.exe](clop%20Setup%202.5.1.exe)**
- **Linux**: скачай [clop-2.5.1.tar.gz](../../releases/download/v2.5.1/clop-2.5.1.tar.gz), распакуй и запусти `./clop`
